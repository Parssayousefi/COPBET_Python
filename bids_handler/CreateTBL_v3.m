function tbl = CreateTBL_2(csvFolderPath)
    ...
    % Specify the directory path where the .mat file will be saved
    directoryPath = '/Users/olivier/Documents/MSc/thesis'; % Replace with your desired directory path

    % Specify the filename for the .mat file
    matFileName = 'tbl_test.mat';
